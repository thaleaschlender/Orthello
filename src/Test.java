  ...
  /*  public class Test {
        ...
        public static void results() {
            ...
            for (int i = 0; i < testruns; i++) {
                ...
                if(game.gameOver && wr<br)bf = bf + 1; else if(game.gameOver) wf += 1;
                else {game.run();}

                if (i + 1 == testruns && game.gameOver == true) printResults(wr, br);//printResults(r);
            }
        }
        ...
        public static void restart(){
            ...
            game.run();
            //if(cnt == testruns); System.out.println("bf: "+ bf +" "+ "wf: "+wf);
        }
